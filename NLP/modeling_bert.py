...
class BertHighway(nn.Module):
    ...
    def forward(self, encoder_outputs):
        ...
        pooled_output = pooler_output # bmodel_output[1]
...
class BertEncoder(nn.Module):
    def __init__(self, config):
        ...
        self.set_early_exit_entropy(0.1)
    
    def init_highway_pooler(self, pooler):
        """
        For initializing the pooler params in each highway with the BERTPooler
        """
    ...
    def forward(
        ...
        outputs = (hidden_states, all_highway_exits, )
        if output_hidden_states:
...
class BertModel(BertPreTrainedModel):
    ...
    Return:
        ...
        return outputs  # sequence_output, pooled_output, entropy
...
class BertForSequenceClassification(BertPreTrainedModel):
    def __init__(self, config):
        ...
        self.highway_penalizer = config.highway_pen
        self.init_weights()
    ...
    Returns:
        ...
        if labels is not None:
            ...
            if self.num_labels == 1:
                ...
                loss_fct = CrossEntropyLoss()
                loss = loss_fct(logits.view(-1, self.num_labels), labels.view(-1)) + losses_highway*self.highway_penalizer
